<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="OrderTool.Login" %>
          ...
          <form>
            <fieldset class='text-center'>
              ...
              <div class='form-group'>
                <input class='form-control' placeholder='LoginID' id ="login_id" type='text'/>
              </div>
              <div class='form-group'>
                <input class='form-control' placeholder='Password'id ="login_pw" type='password'/>
              </div>
